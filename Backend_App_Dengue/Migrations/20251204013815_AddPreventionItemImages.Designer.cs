...
namespace Backend_App_Dengue.Migrations
{
    ...
    [Migration("20251204013815_AddPreventionItemImages")]
    partial class AddPreventionItemImages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.PreventionCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ID_CATEGORIA_PREVENCION");
                    ...
                    b.ToTable("prevention_categories");
                });

            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.PreventionCategoryImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ID_IMAGEN_CATEGORIA");

                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("FK_ID_CATEGORIA_PREVENCION");
                    ...
                    b.ToTable("prevention_category_images");
                });

            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.PreventionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ID_ITEM_PREVENCION");
                    ...
                    b.Property<bool>("IsWarning")
                        ...
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("ES_ADVERTENCIA");

                    b.Property<string>("Title")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("varchar(150)")
                        .HasColumnName("TITULO_ITEM");
                    ...
                    b.ToTable("prevention_items");
                });

            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.PreventionItemImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ID_IMAGEN_ITEM");
                    ...
                    b.Property<int>("ItemId")
                        .HasColumnType("int")
                        .HasColumnName("FK_ID_ITEM_PREVENCION");
                    ...
                    b.ToTable("prevention_item_images");
                });
            ...
            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.UserApprovalRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ID_SOLICITUD")
                        .HasAnnotation("Relational:JsonPropertyName", "ID_SOLICITUD");

                    b.Property<int?>("ApprovedByAdminId")
                        .HasColumnType("int")
                        .HasColumnName("FK_ID_ADMIN")
                        .HasAnnotation("Relational:JsonPropertyName", "FK_ID_ADMIN");

                    b.Property<string>("RejectionReason")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                        .HasColumnName("MOTIVO_RECHAZO")
                        .HasAnnotation("Relational:JsonPropertyName", "MOTIVO_RECHAZO");

                    b.Property<DateTime>("RequestDate")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("FECHA_SOLICITUD")
                        .HasAnnotation("Relational:JsonPropertyName", "FECHA_SOLICITUD");

                    b.Property<int>("RequestedRoleId")
                        .HasColumnType("int")
                        .HasColumnName("ROL_SOLICITADO")
                        .HasAnnotation("Relational:JsonPropertyName", "ROL_SOLICITADO");

                    b.Property<DateTime?>("ResolutionDate")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("FECHA_RESOLUCION")
                        .HasAnnotation("Relational:JsonPropertyName", "FECHA_RESOLUCION");

                    b.Property<string>("RethusData")
                        .HasMaxLength(1000)
                        .HasColumnType("varchar(1000)")
                        .HasColumnName("DATOS_RETHUS")
                        .HasAnnotation("Relational:JsonPropertyName", "DATOS_RETHUS");

                    b.Property<string>("RethusError")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                        .HasColumnName("ERROR_RETHUS")
                        .HasAnnotation("Relational:JsonPropertyName", "ERROR_RETHUS");
                    ...
                    b.Property<string>("Status")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "ESTADO_SOLICITUD");
                    ...
                    b.ToTable("solicitud_aprobacion_usuario");
                });
            ...
            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.PreventionCategoryImage", b =>
                {
                    b.HasOne("Backend_App_Dengue.Data.Entities.PreventionCategory", "Category")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.PreventionItemImage", b =>
                {
                    b.HasOne("Backend_App_Dengue.Data.Entities.PreventionItem", "Item")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Backend_App_Dengue.Data.Entities.UserApprovalRequest", b =>
                {
                    b.HasOne("Backend_App_Dengue.Data.Entities.User", "ApprovedByAdmin")
                        .WithMany()
                        .HasForeignKey("ApprovedByAdminId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Backend_App_Dengue.Data.Entities.Role", "RequestedRole")
                        .WithMany()
